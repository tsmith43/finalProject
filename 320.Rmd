...
dots <- shark_data%>%
  ...
  ggplot(aes(x=Year,y=Activity, color = Country)) + geom_point() + labs(title = "Attacks Throughout the Years based on Activity", x ="Years", y = "Activity when Attacked")
...
```
  ...
  We begin to analyze the effect that surfing has in a given country. We can find this effect by finding the proportional relationship between the number of surfing attacks for each country. Found below is a plot of those proportions.
